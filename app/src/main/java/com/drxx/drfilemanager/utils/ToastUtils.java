...
public class ToastUtils {
    ...
    public static void showShort( CharSequence message) {
        if (isShow) {
            if (mToast == null) {
                mToast = Toast.makeText(DrApplication.getInstance().getApplicationContext(), message, Toast.LENGTH_SHORT);
            } else {
    ...
    public static void showShort( int resId) {
        if (isShow) {
            if (mToast == null) {
                mToast = Toast.makeText(DrApplication.getInstance().getApplicationContext(), resId, Toast.LENGTH_SHORT);
            } else {
    ...
    public static void showLong(CharSequence message) {
        if (isShow) {
            if (mToast == null) {
                mToast = Toast.makeText(DrApplication.getInstance().getApplicationContext(), message, Toast.LENGTH_LONG);
            } else {
                mToast.setText(message);
            }
            mToast.show();
    ...
    public static void showLong( int resId) {
        if (isShow) {
            if (mToast == null) {
                mToast = Toast.makeText(DrApplication.getInstance().getApplicationContext(), resId, Toast.LENGTH_LONG);
            } else {
                mToast.setText(resId);
            }
            mToast.show();
    ...
    public static void show( CharSequence message, int duration) {
        if (isShow) {
            if (mToast == null) {
                mToast = Toast.makeText(DrApplication.getInstance().getApplicationContext(), message, duration);
            } else {
                mToast.setText(message);
            }
            mToast.show();
    ...
    public static void show(int resId, int duration) {
        if (isShow) {
            if (mToast == null) {
                mToast = Toast.makeText(DrApplication.getInstance().getApplicationContext(), resId, duration);
            } else {
                mToast.setText(resId);
            }
            mToast.show();
